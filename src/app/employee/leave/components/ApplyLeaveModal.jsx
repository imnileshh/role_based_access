...
const ApplyLeaveModal = ({ onClose }) => {
    ...
    return (
        <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
            <div className="relative w-4xl mx-auto p-6 bg-white rounded shadow space-y-4 text-black max-h-[90vh] overflow-y-auto">
                ...
                <div className="absolute top-2 right-4">
                    <button className="w-8 h-8 text-white bg-red-500 rounded-lg " onClick={onClose}>
                        X
                    </button>
                </div>
